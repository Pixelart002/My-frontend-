  ...
  return (
    <header className="header sticky top-0 z-[120] isolate h-[72px] min-h-[72px] border-b border-[rgb(255_255_255_/_0.07)] bg-[rgb(8_8_8_/_0.94)] text-text backdrop-blur-xl transition-[box-shadow,background-color] duration-200 max-[900px]:h-[68px] max-[900px]:min-h-[68px] max-[900px]:backdrop-blur-none">
      ...
      <aside
        ...
        className={`mobile-nav fixed inset-y-0 left-0 z-[120] flex h-dvh w-[min(360px,88vw)] max-w-[360px] flex-col overflow-hidden rounded-r-[20px] border-r border-line bg-surface shadow-[20px_0_70px_rgba(0,0,0,.48)] transition-transform duration-200 ease-[cubic-bezier(.22,.61,.36,1)] motion-reduce:transition-none max-[640px]:w-[min(340px,90vw)] min-[901px]:bottom-0 min-[901px]:left-auto min-[901px]:right-0 min-[901px]:top-[72px] min-[901px]:h-[calc(100dvh-72px)] min-[901px]:w-[min(380px,92vw)] min-[901px]:rounded-l-[18px] min-[901px]:rounded-r-none min-[901px]:border-l min-[901px]:border-r-0 min-[901px]:shadow-[-20px_0_70px_rgba(0,0,0,.48)] min-[1100px]:w-[min(360px,42vw)] ${mobileOpen ? 'pointer-events-auto visible max-[900px]:translate-x-0 min-[901px]:translate-x-0' : 'pointer-events-none invisible max-[900px]:-translate-x-full min-[901px]:translate-x-full'}`}
